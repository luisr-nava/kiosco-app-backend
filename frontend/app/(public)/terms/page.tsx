          ...
          <CardContent className="prose dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground mb-4">
                Al acceder y utilizar Balanzio (en adelante, &quot;la Aplicación&quot;), usted
                acepta estar sujeto a estos Términos y Condiciones. Si no está de acuerdo con alguna
                parte de estos términos, no debe utilizar nuestra aplicación.
              </p>
              <p className="text-muted-foreground">
                Nos reservamos el derecho de actualizar o modificar estos términos en cualquier
                momento sin previo aviso. El uso continuo de la Aplicación después de dichos cambios
            ...
            <section className="mb-8">
              <h2 className="mb-4 text-2xl font-semibold">3. Registro y Cuenta de Usuario</h2>
              <p className="text-muted-foreground mb-4">
                Para utilizar la Aplicación, debe crear una cuenta proporcionando información
              ...
              <p className="text-muted-foreground mt-4">
                ...
                o que consideremos fraudulentas.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground mb-4">
                ...
                exclusiva de Balanzio y están protegidos por derechos de autor, marcas registradas y
                otras leyes de propiedad intelectual.
              </p>
              <p className="text-muted-foreground">
                Los datos que usted ingresa en el sistema son de su propiedad, pero nos otorga una
                licencia para procesarlos y almacenarlos con el fin de proporcionar el servicio.
              </p>
            </section>

            <section className="mb-8">
              <h2 className="mb-4 text-2xl font-semibold">6. Privacidad y Datos</h2>
              <p className="text-muted-foreground mb-4">
                Su privacidad es importante para nosotros. El uso de su información personal se rige
                por nuestra{" "}
              ...
              <p className="text-muted-foreground">
                ...
                pero no podemos garantizar la seguridad absoluta de la información transmitida a
                través de Internet.
              </p>
            </section>

            <section className="mb-8">
              <h2 className="mb-4 text-2xl font-semibold">7. Facturación y Pagos</h2>
              <p className="text-muted-foreground mb-4">
                Algunos servicios de la Aplicación pueden requerir el pago de tarifas. Al
                suscribirse a un plan de pago:
              </p>
              <ul className="text-muted-foreground ml-4 list-inside list-disc space-y-2">
                <li>Acepta pagar todas las tarifas asociadas con su plan seleccionado</li>
                <li>Las suscripciones se renuevan automáticamente a menos que las cancele</li>
            ...
            <section className="mb-8">
              <h2 className="mb-4 text-2xl font-semibold">8. Disponibilidad del Servicio</h2>
              <p className="text-muted-foreground mb-4">
                Si bien nos esforzamos por mantener la Aplicación disponible 24/7, no podemos
                garantizar que el servicio esté libre de interrupciones, retrasos o errores.
              </p>
              <p className="text-muted-foreground">
            ...
            <section className="mb-8">
              ...
              <ul className="text-muted-foreground ml-4 list-inside list-disc space-y-2">
                ...
                <li>Cualquier daño derivado del uso o imposibilidad de usar la Aplicación</li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground">
                Usted acepta indemnizar y mantener indemne a Balanzio y sus afiliados de cualquier
                reclamación, daño, pérdida, responsabilidad y gasto (incluidos honorarios legales)
                que surjan de su uso de la Aplicación o violación de estos términos.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground mb-4">
                Podemos suspender o cancelar su acceso a la Aplicación inmediatamente, sin previo
                aviso ni responsabilidad, por cualquier motivo, incluido el incumplimiento de estos
                Términos y Condiciones.
              </p>
              <p className="text-muted-foreground">
                Usted puede cancelar su cuenta en cualquier momento desde la configuración de su
                perfil.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground">
                Estos términos se rigen por las leyes aplicables en su jurisdicción. Cualquier
                disputa relacionada con estos términos se resolverá en los tribunales competentes de
                su localidad.
              </p>
            </section>
            ...
            <div className="text-muted-foreground text-center text-sm">
              <p>
                Al utilizar Balanzio, usted reconoce que ha leído, entendido y acepta estar sujeto a
