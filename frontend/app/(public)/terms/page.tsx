          ...
          <CardContent className="prose dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground">
                ...
                momento sin previo aviso. El uso continuo de la Aplicación después de dichos
                cambios constituirá su aceptación de los nuevos términos.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground mt-4">
                ...
                términos o que consideremos fraudulentas.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground">
                Los datos que usted ingresa en el sistema son de su propiedad, pero nos otorga
                una licencia para procesarlos y almacenarlos con el fin de proporcionar el
                servicio.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground mb-4">
                Su privacidad es importante para nosotros. El uso de su información personal se
                rige por nuestra{" "}
              ...
              <p className="text-muted-foreground">
                ...
                datos, pero no podemos garantizar la seguridad absoluta de la información
                transmitida a través de Internet.
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4">7. Facturación y Pagos</h2>
              <p className="text-muted-foreground mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4">11. Rescisión</h2>
              <p className="text-muted-foreground mb-4">
                Podemos suspender o cancelar su acceso a la Aplicación inmediatamente, sin previo
                aviso ni responsabilidad, por cualquier motivo, incluido el incumplimiento de
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground">
                ...
                disputa relacionada con estos términos se resolverá en los tribunales competentes
                de su localidad.
              </p>
            </section>
